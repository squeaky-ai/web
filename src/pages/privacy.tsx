    ...
    <>
      <section className='hero'>
        <Container className='centered md'>
          ...
          <p>We <Link href='#'>founded Squeaky</Link> to provide <b>the first truly comprehensive, privacy-friendly product and web analytics suite</b>. However, at the heart of that mission lies a contradiction, as great <b>web and product analytics tools inherently capture a lot data</b>. So, how exactly does Squeaky provide an incredible turnkey analytics tool, whilst also protecting end users from arbitrary or invasive data capture?</p>
