...
const CmsAnalyticsWordpress: SqueakyPage<NextPage> = () => {
...
CmsAnalyticsWordpress.getMetaData = () => ({
  title: 'Squeaky | CMS Analytics | Wordpress',
  description: 'Find out how Squeaky\'s easy-to-use and privacy-friendly analytics solution can help improve the user experience and performance of your Wordpress website',
  index: true,
});

export default CmsAnalyticsWordpress;
