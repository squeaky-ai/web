...
const CmsAnalyticsShopify: SqueakyPage<NextPage> = () => {
...
CmsAnalyticsShopify.getMetaData = () => ({
  title: 'Squeaky | CMS Analytics | Shopify',
  description: 'Find out how Squeaky\'s easy-to-use and privacy-friendly analytics solution can help improve the user experience and performance of your Shopify website',
  index: true,
});

export default CmsAnalyticsShopify;
