...
const CmsAnalyticsWix: SqueakyPage<NextPage> = () => {
  ...
  return (
    <>
      <CmsAnalyticsHeader
        title='Powerful, privacy-first analytics for Wix'
        image='wix'
        body={
          <>
...
CmsAnalyticsWix.getMetaData = () => ({
  title: 'Squeaky | CMS Analytics | Wix',
  description: 'Find out how Squeaky\'s easy-to-use and privacy-friendly analytics solution can help improve the user experience and performance of your Wix website',
  index: true,
});

export default CmsAnalyticsWix;
